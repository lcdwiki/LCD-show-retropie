...
1.)Step1, Install Retropie official mirror <br>
====================================================
  a)Download Retropie official mirror:<br>
  https://retropie.org.uk/download/<br>
...
```sudo rm -rf LCD-show-retropie```<br>
```git clone https://github.com/lcdwiki/LCD-show-retropie.git```<br>
```chmod -R 755 LCD-show-retropie```<br>
```cd LCD-show-retropie/```<br>
